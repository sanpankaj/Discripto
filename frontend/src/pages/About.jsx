        ...
        <div>
            ...
            <div className="my-10 flex  flex-col md:flex-row gap-12">
                ...
                <div className='flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600  '>
                    ...
                    <p>Our vision at Prescripto is to create a seamless healthcare experience for every user.
                        We aim to bridge the gap between patients and healthcare providers, making it easier for you to access the care you need, when you need it.</p>
                </div>
            </div>
            <div className='text-xl my-4'>
             ...
             <div className='flex flex-col md:flex-row mb-20'>
                <div className='border px-10 md:px-16 py-8 flex flex-col gap-5 text-[15px] hover:bg-primary hover:text-white transition-all duration-300'>
                    <b>EFFICIENCY:</b>
